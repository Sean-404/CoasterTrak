 ...
 */
const COASTER_FIXES_BY_WIKIDATA_ID: Record<string, Partial<Pick<Coaster, "name" | "inversions">>> = {
...
export function applyCoasterKnownFixes<T extends Pick<Coaster, "name"> & Partial<Pick<Coaster, "wikidata_id" | "inversions">>>(
  c: T,
): T {
